...
## Identify differentially expressed GENES (DEGs) between subspecies.
## Returns FoldChange, too (getFC = TRUE)
...
# Filter based on p-value and q-value
DEG_subspecies_filtered_stat_results <- filter(DET_subspecies_stat_results, pval <= pvalue & qval <= qvalue)
