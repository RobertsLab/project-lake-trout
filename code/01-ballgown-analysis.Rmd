...
```
## Identify differentially expressed transcripts (DETs) between subspecies.
...
merged_DET_subspecies_pval_filtered <- merged_DET_subspecies_pval_filtered %>% mutate(start = start - 1)
head(merged_DET_subspecies_pval_filtered)
...
write.csv(
  ...
  file = "../analyses/merged_DET_subspecies_pval_filtered_p-0.05.csv", 
  quote = FALSE, 
  row.names = FALSE)
...
write.table(
  ...
  file = "../analyses/DET_subspecies_filtered_p-0.05.bed",
  sep = "\t",
  col.names = FALSE,
  row.names = FALSE,
  quote = FALSE
...
write.table(
  ...
  file = "../analyses/DET_sex_female_filtered_p-0.05.bed",
  sep = "\t",
  col.names = FALSE,
  row.names = FALSE,
  quote = FALSE
...
write.table(
  ...
  file = "../analyses/DET_subspecies_pval_filtered_siscowet_p-0.05.bed",
  sep = "\t",
  col.names = FALSE,
  row.names = FALSE,
  quote = FALSE
