...
PacBio long-read sequencing revealed extensive structural variation between ecotypes. Siscowet lake trout harbor significantly more unique insertions and deletions compared to lean ecotypes, suggesting greater genomic diversity potentially associated with deep-water adaptation.
:::

::: {.finding-box}
### 📊 DNA Methylation Differences
Whole-genome bisulfite sequencing identified **302 differentially methylated regions (DMRs)** and **4,440 significant differentially methylated CpGs (DMCs)** between ecotypes. These epigenetic differences may contribute to phenotypic divergence without changes to the underlying DNA sequence.
:::
...
<li>Intuitive navigation with click-and-drag</li>
<li>Smooth zooming with scroll wheel</li>
<li>Pre-configured track visibility</li>
<li>Quick region navigation</li>
<li>Ideal for reviewing specific loci</li>
</ul>
...
<ul class="advantage-list">
<li>Full-featured genome browser</li>
<li>Multiple synchronized views</li>
<li>Advanced track configuration</li>
<li>Plugin extensibility</li>
<li>Dot plot & synteny views</li>
<li>Better for complex comparisons</li>
</ul>
...
- **Lab Website**: [Roberts Lab](https://robertslab.github.io/)
