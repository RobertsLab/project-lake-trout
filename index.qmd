...
Explore methylation, PAV, and gene tracks directly across the SaNama_1.0 assembly.

::: {.columns}
::: {.column width="50%"}
### 🔬 IGV.js — *quick exploration*
Gene annotations · PAV insertions & deletions · CpG methylation (8 samples) · DMRs

<a href="genome-browser/index.html" class="browser-link">Launch IGV Browser →</a>
:::
::: {.column width="50%"}
### 🧬 JBrowse 2 — *advanced analysis*
Gene annotations (BED) · PAV structural variants · CpG methylation BigWig · differential methylation
